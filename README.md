...
- El envío por WhatsApp está simulado para el flujo. Esta base se puede ampliar con integración real.
- La cámara requiere permisos del navegador (acepta la solicitud de acceso).
